...
autoketik = false;
prefixStatus = true;
targetpc = "51918303426"; 
owner = "51918303426"; 
fakeyoi = "८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]"; 
HunterApi = "Ikyy69", 
xchillds = 'XChillDs' 
hardi = 'hardianto', 
valkey = "rivalgans", 
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`51918303426@s.whatsapp.net`]
...
const fvid = {
	 key: { 
          fromMe: false,
	      participant: `51918303426@s.whatsapp.net`, ...(from ? 
	 { remoteJid: "6289643739077-1613049930@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
      ...
      message: {
        productMessage: {
          product: {
            ...
            title: "Sofff-Bot",
            description: "८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "By ८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]",
            productImageCount: 1,
          },
...
///// RESPUESTAS AUTOMATICAS BY DARLYN
if(budy.includes('Bot')) {cnf.sendMessage(from, 'Eu, que quieres?', MessageType.text, {quoted: fvn})}	  
if(budy.includes('Darlyn')) {cnf.sendMessage(from, 'Dile que pase CP', MessageType.text, {quoted: fstick})}	  
if(budy.includes('Pene')) {cnf.sendMessage(from, 'Comes uh', MessageType.text, {quoted: mek})}	
if(budy.includes('Sexo')) {cnf.sendMessage(from, 'Pasa bb', MessageType.text, {quoted: mek})}		    
////// RESPUESTAS AUTOMATICAS BY DARLYN
	  
	  
///// RESPUESTAS AUTOMATICAS DE STICKERS BY DARLYN
/*if(budy==('Hola')){result = fs.readFileSync(`./dararchivos/pegatina/darin1.webp`),cnf.sendMessage(from, result, sticker, {quoted: fdoc})}
if(budy==('hola')){result = fs.readFileSync(`./dararchivos/pegatina/darin2.webp`),cnf.sendMessage(from, result, sticker, {quoted: fdoc})}
if(budy==('ola')){result = fs.readFileSync(`./dararchivos/pegatina/darin3.webp`),cnf.sendMessage(from, result, sticker, {quoted: fdoc})}
if(budy==('Ola')){result = fs.readFileSync(`./dararchivos/pegatina/darin4.webp`),cnf.sendMessage(from, result, sticker, {quoted: fdoc})}
if(budy==('pene')){result = fs.readFileSync(`./dararchivos/pegatina/darin5.webp`),cnf.sendMessage(from, result, sticker, {quoted: fdoc})}
if(budy==('Pene')){result = fs.readFileSync(`./dararchivos/pegatina/darin6.webp`),cnf.sendMessage(from, result, sticker, {quoted: fdoc})}
if(budy==('Gracias')){result = fs.readFileSync(`./dararchivos/pegatina/darin7.webp`),cnf.sendMessage(from, result, sticker, {quoted: fdoc})}
if(budy==('gracias')){result = fs.readFileSync(`./dararchivos/pegatina/darin8.webp`),cnf.sendMessage(from, result, sticker, {quoted: fdoc})}
if(budy==('sexo')){result = fs.readFileSync(`./dararchivos/pegatina/darin9.webp`),cnf.sendMessage(from, result, sticker, {quoted: fdoc})}
if(budy==('Sexo')){result = fs.readFileSync(`./dararchivos/pegatina/darin10.webp`),cnf.sendMessage(from, result, sticker, {quoted: fdoc})}
if(budy==('QUE')){result = fs.readFileSync(`./dararchivos/pegatina/darin11.webp`),cnf.sendMessage(from, result, sticker, {quoted: fdoc})}*/  
///// RESPUESTAS AUTOMATICAS DE STICKERS BY DARLYN
	  
///// RESPUESTAS AUTOMATICAS DE IMAGENES BY DARLYN	  
if(budy==('Catalunya')){result = fs.readFileSync(`./dararchivos/imagen/sagradafamilia.jpg`),cnf.sendMessage(from, result, image, {quoted: fgif})}
if(budy==('ZING')){result = fs.readFileSync(`./dararchivos/imagen/sofff.jpg`),cnf.sendMessage(from, result, image, {quoted: ftok})}
if(budy==('DARLYN')){result = fs.readFileSync(`./dararchivos/imagen/yo.jpg`),cnf.sendMessage(from, result, image, {quoted: ftroli})}
if(budy==('FONDOXD')){result = fs.readFileSync(`./cnf.jpg`),cnf.sendMessage(from, result, image, {quoted: ftok})}

/*if(budy==('QUE')){result = fs.readFileSync(`./dararchivos/pegatina/darin11.webp`),cnf.sendMessage(from, result, image, {quoted: mek})}*/	 
///// RESPUESTAS AUTOMATICAS DE IMAGENES BY DARLYN
	  
///// RESPUESTAS AUTOMATICAS DE VIDEO BY DARLYN	  
/*if(budy==('Disfraz')){result = fs.readFileSync(`./dararchivos/videos/axd.mp4`),cnf.sendMessage(from, result, video, {quoted: mek})}	  
if(budy==('Itzy')){result = fs.readFileSync(`./dararchivos/videos/itzy.mp4`),cnf.sendMessage(from, result, video, {quoted: mek})}
if(budy==('Jennie')){result = fs.readFileSync(`./dararchivos/videos/jennie.mp4`),cnf.sendMessage(from, result, video, {quoted: mek})}
if(budy==('Muslos')){result = fs.readFileSync(`./dararchivos/videos/muslosxd.mp4`),cnf.sendMessage(from, result, video, {quoted: mek})}
if(budy==('PAREJAS')){result = fs.readFileSync(`./dararchivos/videos/parejas.mp4`),cnf.sendMessage(from, result, video, {quoted: mek})}
if(budy==('TETAS')){result = fs.readFileSync(`./dararchivos/videos/quexd.mp4`),cnf.sendMessage(from, result, video, {quoted: mek})}
if(budy==('Twice')){result = fs.readFileSync(`./dararchivos/videos/sana.mp4`),cnf.sendMessage(from, result, video, {quoted: mek})}
if(budy==('disfraz')){result = fs.readFileSync(`./dararchivos/videos/swagxd.mp4`),cnf.sendMessage(from, result, video, {quoted: mek})}*/
///// RESPUESTAS AUTOMATICAS DE VIDEO BY DARLYN	
...
/////////////////////////////////////////////////////////////////////////////
	                if (budy.includes(`SEXOO`)){
                        ...
                        rm = [
                        result = fs.readFileSync(`./dararchivos/pegatina/darin1.webp`),
                        result1 = fs.readFileSync(`./dararchivos/pegatina/darin2.webp`),
                        result2 = fs.readFileSync(`./dararchivos/pegatina/darin3.webp`),
                        result3 = fs.readFileSync(`./dararchivos/pegatina/darin4.webp`),
                        result4 = fs.readFileSync(`./dararchivos/pegatina/darin5.webp`),
                        result5 = fs.readFileSync(`./dararchivos/pegatina/darin6.webp`),
                        result6 = fs.readFileSync(`./dararchivos/pegatina/darin7.webp`),
                        result7 = fs.readFileSync(`./dararchivos/pegatina/darin8.webp`),
                        result8 = fs.readFileSync(`./dararchivos/pegatina/darin9.webp`),
                        result9 = fs.readFileSync(`./dararchivos/pegatina/darin10.webp`),
                        result10 = fs.readFileSync(`./dararchivos/pegatina/darin11.webp`),
		        ]
                        nk = rm[Math.floor(Math.random() * rm.length)]
                        cnf.sendMessage(from, nk, sticker)
                        }
	  
	  
if (budy.includes(`AEAE`)){
cnf.updatePresence(from, Presence.composing)
rm = [
result = fs.readFileSync(`./dararchivos/random/jen.jpg`),
result1 = fs.readFileSync(`./dar29.jpg`),
result2 = fs.readFileSync(`./cofi2.jpg`),
result3 = fs.readFileSync(`./darlynuh.jpg`),
result4 = fs.readFileSync(`./dararchivos/random/Lisa.jpg`),
result5 = fs.readFileSync(`./dararchivos/random/jennie1234.jpg`),
]
nk = rm[Math.floor(Math.random() * rm.length)]
cnf.sendMessage(from, nk, image)
}
...
/*if (budy.includes('Sexo')){buf = fs.readFileSync(`./dararchivos/audios/dar1.mp3`),cnf.sendMessage(from, buf, audio, {mimetype : 'audio/mp4', ptt:true})}*/	
/*if (budy.includes('Sexo')){buf = fs.readFileSync(`./darsofi.mp3`),cnf.sendMessage(from, buf, audio, {mimetype : 'audio/mp4', quoted: fdoc, duration: -200721, ptt:true, contextInfo:{ forwardingScore: 999999, isForwarded: true}})}*/
...
*「 ८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁] 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `menu`,buttonText:{displayText: `🌿MENU🌿`},type:1}]
              ...
              buttonsMessage = {footerText:'८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]', imageMessage: imageMsg,
...
prep = await cnf.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
               ...
               case 'status':
                ...
                break
/*case 'location':
  cnf.sendMessage(from, { "degreesLatitude": '', "degreesLongitude": '', `jpegThumbnail` }, MessageType.location, {quoted: fgif})
break*/
	...
	case 'infobot':
                ...
                groups = cnf.chats.array.filter(v => v.jid.endsWith('g.us'))
                              ...
                              total = math(`${groups.length}*${privat.length}`)
		txtt =`Hola! ${pushname}`
                               buttons = [{buttonId:`menu`, 
                               buttonText:{displayText: 'Menu'},type:1},
                               {buttonId:`creditos`,buttonText:{displayText:'creditos'},type:1},
                               {buttonId:`uh`,buttonText:{displayText:'owner'},type:1}]
                
             
                               imageMsg = (await cnf.prepareMessageMedia(fs.readFileSync(`./stik/thumb.jpeg`), 'imageMessage', {thumbnail: fs.readFileSync(`./stik/thumb.jpeg`)})).imageMessage
                               buttonsMessage = {
                               contentText: `${txtt}`,
                               footerText: `
८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]
_*𝙀𝙨𝙩𝙖𝙙𝙤: Publico*_
_*PREFIJO: Multiprefijo*_
_*OWNER:*_ https://wa.me/51918303426              
𝐆𝐫𝐮𝐩𝐨 𝐂𝐡𝐚𝐭𝐬 : ${groups.length} 
𝐏𝐫𝐢𝐯𝐚𝐝𝐨 𝐂𝐡𝐚𝐭𝐬 : ${privat.length}
𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : ${totalChat.length}
𝐕𝐞𝐥𝐨𝐜𝐢𝐝𝐚𝐝 : ${latensie.toFixed(4)} _Second_
...
Ahi tienes la info del bot ${pushname}`, imageMessage: imageMsg,
                               buttons: buttons,
                               headerType: 4
                               }
                               prep = await cnf.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
                    ...
                    {buttonId:`creditos`,buttonText:{displayText:'....'},type:1},
                    {buttonId:`xdxd`,buttonText:{displayText:'....'},type:1}]
     
  
                                               imageMsg = (await cnf.prepareMessageMedia(fs.readFileSync(`./cofi2.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./cofi2.jpg`)})).imageMessage
                                               buttonsMessage = {
                                               contentText: `${txtt}`,
                                               footerText: `
▭▬▬ ▬ ▬▬▬▬▙ • ▟▬▬▬▬ ▬ ▬▬▭
...
> ⬡ ${prefix}ecchi
▭▬▬ ▬ ▬▬▙ • ▟▬▬ ▬ ▬▬▭
Numero del owner: wa.me/51918303426
Ahi tienes el menu del bot ${pushname}
...
groups = cnf.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              latensie = speed() - timestampe
              total = math(`${groups.length}*${privat.length}`)
        ptod = "51918303426@s.whatsapp.net"
        dtod = '51918303426'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
𝗡𝗼𝘁𝗮 : NO SPAM AQUEROSO/A.
Numero del owner: wa.me/51918303426
`
sendButLocation(from, `${menu}`,`Bot by @${dtod.split("@")[0]}`, {jpegThumbnail:iye}, [{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`script`,buttonText:{displayText:'XD'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
break
...
⬡ pkg install wget
⬡ pkg install ffmpeg
⬡ git clone https://github.com/darin2920
⬡ cd 
⬡  npm install
...
const allMem = await cnf.GroupMembers(from)
for (let i = 0; i < allMem.length; i++) {
if (groupAdmins.includes(allMem[i].id)) {
} else {
await cnf.removeParticipant(from, allMem[i].id)}}
reply('✍🏻')
break
        case 'gris':
	case 'sinleer':
	...
	case 'vaciarchats':
		...
		case 'delete':
	      ...
	      case 'darlyn':
              ...
              damdu = fs.readFileSync(`./dararchivos/random/${random}.jpg`)
              cnf.sendMessage(from, damdu, image, {quoted: mek})
              break		
case 'boobs':
if (isBanned) return  reply(mess.banned)
...
🌿 : https://wa.me/${dtod.split('@')[0]}
🌿 : https://wa.me/${dtod2.split('@')[0]}
 `
     credit = cnf.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 800000, "message": `${yez}`, "footerText": "By ८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]", "thumbnail": iye, "surface": 'CATALOG'}}, {quoted: mek})
            cnf.relayWAMessage(credit)
        break	
case 'uh':
  if (!isGroup) return reply(mess.banned)
  dtod = '51918303426'
  dtod2 = '51956570030'
  var yez = `
  https://wa.me/${dtod.split('@')[0]}
  ...
  https://instagram.com
  `
  credit = cnf.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 999999, "message": `${yez}`, "footerText": "By ८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]", "thumbnail": iye, "surface": 'CATALOG'}}, {quoted: mek})
            cnf.relayWAMessage(credit)
        break
...
case 'XD':
                if (isBanned) return  reply(mess.banned)
              dtod = '51918303426'
              var yez = `Hola maricon culiao
                        `
               credit = cnf.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 847580, "message": `${yez}`, "footerText": "By ८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]", "thumbnail": iye, "surface": 'CATALOG'}}, {quoted: mek})
                      cnf.relayWAMessage(credit)
                  break		
...
if (isBanned) return  reply(mess.banned)         
               ...
               buttons = [{buttonId: `script`,buttonText:{displayText: 'Hola uh'},type:1},{buttonId:`iggw`,buttonText:{displayText:'WA.ME'},type:1}]
...
break
                     				case 'crash': 
if (!mek.key.fromMe) return;
cnf.sendMessage(mek.key.remoteJid, '𝐂𝐫𝐚𝐬𝐡 𝐛𝐲 ८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]', MessageType.extendedText, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net'
  },
...
if (isBanned) return  reply(mess.banned)
 ...
 footerText: '𝑆𝑜𝑓𝑓𝑓-𝗕𝗼𝘁|८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]',
...
⎙ ${prefix}twitter <link>
`
sendButMessage(from, menu, `𝑆𝑜𝑓𝑓𝑓-𝗕𝗼𝘁`, [
          {
            buttonId: `command`,
            buttonText: {
...
⬡ ${prefix}dados
`
sendButMessage(from, menu, ` 𝓓𝓪𝓻𝓵𝔂𝓷`, [
          {
            buttonId: `command`,
            buttonText: {
...
⎙ ${prefix}autojoin
`
sendButMessage(from, menu, `𝑆𝑜𝑓𝑓𝑓-𝗕𝗼𝘁|८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, [
          {
            buttonId: `command`,
            buttonText: {
              displayText: `⬡ VOLVER AL MENU `,
...
mentions(`*▢ Mensaje:* ${c}\n▢ *Grupo:*  ${groupName}\n*▢ Miembros:* ${groupMembers.length} \n*▢ Total De Admins:* ${groupAdmins.length}\n┌───⊷ *MENCIONES* ⊶`+teks+'└────✪ •८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]🌹 ᵇᵒᵗ✪──── ', members_id, true)
break
					//by 𝑆𝑜𝑓𝑓𝑓-𝗕𝗼𝘁
					          case 'phcomment':
...
if (!q)return 
var itsme = `${sender}`
var split = `*𝑆𝑜𝑓𝑓𝑓 ८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]*`
const term = {
contextInfo: {
participant: itsme,
quotedMessage: {
